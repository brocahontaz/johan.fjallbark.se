      ...
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <defs>
          ...
          <g id="eff">
            ...
            <rect id="wave-1" className="water-fill" mask="url(#text-mask)" fill="url(#water)" x="-300" y="80" width="1200" height="50%" opacity="0.3">
              <animate attributeType="xml" attributeName="x" from="-300" to="0" repeatCount="indefinite" dur="2s"/>
            </rect>
            <rect id="wave-2" className="water-fill" mask="url(#text-mask)" fill="url(#water)" y="75" width="1600" height="50%" opacity="0.3">
              <animate attributeType="xml" attributeName="x" from="-400" to="0" repeatCount="indefinite" dur="3s"/>
            </rect>
            <rect id="wave-3" className="water-fill" mask="url(#text-mask)" fill="url(#water)" y="85" width="2000" height="50%" opacity="0.3">
              <animate attributeType="xml" attributeName="x" from="-500" to="0" repeatCount="indefinite" dur="1.4s"/>
            </rect>
            <rect id="wave-4" className="water-fill" mask="url(#text-mask)" fill="url(#water)" y="85" width="2400" height="50%" opacity="0.3">
